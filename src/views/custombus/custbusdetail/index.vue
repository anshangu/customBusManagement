      ...
      <avue-crud ref="crud"
        ...
        <template slot="menuLeft">
          <el-button type="primary"
                     @click="handleAdd"
                     size="small"
                     v-if="permissions.tcapp_custbusdetail_add">新增</el-button>
          <br /><br />
        </template>
        <template slot-scope="scope"
                  slot="menu">
          <el-button type="primary"
                     v-if="permissions.tcapp_custbusdetail_edit"
                     icon="el-icon-check"
                     size="small"
                     plain
                     @click="handleEdit(scope.row,scope.index)">编辑</el-button>
          <el-button type="danger"
                     v-if="permissions.tcapp_custbusdetail_del"
                     icon="el-icon-delete"
                     size="small"
                     plain
...
<script>
  import { fetchList, getObj, addObj, putObj, delObj } from '@/api/custombus/custbusdetail'
